      ...
      <div className="">
        ...
        <PageBorders>
          <div className="flex flex-col gap-4 md:gap-8 ">
            <HeaderOne text={""} textLeft={true} />
            <div className="grid md:grid-cols-2 gap-4 md:gap-8">
              {/* image */}
              <div className="bg-features5 bg-cover bg-top bg-no-repeat h-full rounded-[30px]" />
              {/* text */}
              <div className="flex flex-col gap-4 md:gap-8 p-[30px]">
                ...
                <HeaderOne
                  ...
                  size={"text-[40px] leading-[40px] font-semibold"}
                  textLeft={true}
                />
                <p className=" text-[8px]  leading-[10px] md:text-[16px] md:leading-[16px] text-mainBlack ">
